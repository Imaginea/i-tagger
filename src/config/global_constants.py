...
PAD_WORD_ID = global_constants.get_item_as_int("VOCAB", "padding_word_id")
UNKNOWN_WORD_ID = global_constants.get_item_as_int("VOCAB", "unknown_word_id")

PAD_CHAR = global_constants.get_item("VOCAB", "padding_char")
UNKNOWN_CHAR = global_constants.get_item("VOCAB", "unknown_char")

PAD_CHAR_ID = global_constants.get_item_as_int("VOCAB", "padding_char_id")
UNKNOWN_CHAR_ID = global_constants.get_item_as_int("VOCAB", "unknown_char_id")
