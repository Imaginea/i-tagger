...
class BiLSTMCRFConfigV2(IModelConfig):
    def __init__(self,
                 model_dir,
                 vocab_size,
                 char_vocab_size,
        ...
        self.POS_VOCAB_FILE = pos_vocab_file
    ...
    def with_user_hyperparamaters(experiment_root_dir, data_iterator):
        ...
        model_config = BiLSTMCRFConfigV2(model_dir=model_dir,
                                         ...
                                         pos_vocab_file=data_iterator.POS_VOCAB_FILE,
                                         # hyper parameters
    ...
    def _model_fn(self, features, labels, mode, params):
        ...
        with tf.variable_scope("char_word_embeddings-mergeing_layer"):
            if self.ner_config.USE_CHAR_EMBEDDING:
                ...
                encoded_doc = tf.concat([encoded_sentence], axis=-1)
